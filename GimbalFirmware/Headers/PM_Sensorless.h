...
#define DEFAULT_GMB_ROLL_P 8.0
#define DEFAULT_GMB_ROLL_I 0.3
#define DEFAULT_GMB_ROLL_D 0.0
#define DEFAULT_GMB_ROLL_D_A 0.5

#define DEFAULT_GMB_YAW_P 6.0
#define DEFAULT_GMB_YAW_I 0.275
#define DEFAULT_GMB_YAW_D 0.0
#define DEFAULT_GMB_YAW_D_A 0.5

#define DEFAULT_GMB_PITCH_P 2.25
#define DEFAULT_GMB_PITCH_I 0.15
#define DEFAULT_GMB_PITCH_D 0.0
