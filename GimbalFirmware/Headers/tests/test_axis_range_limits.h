...
typedef enum {
    ...
    RANGE_LIMITS_STATE_MOVE_OFF_POS_STOP,
    RANGE_LIMITS_STATE_CHECK_NEGATIVE_TORQUE_POS_TO_HOME,
    RANGE_LIMITS_STATE_CHECK_NEGATIVE_TORQUE_HOME_TO_NEG,
    RANGE_LIMITS_STATE_CHECK_POSITIVE_TORQUE_NEG_TO_HOME,
    RANGE_LIMITS_STATE_CHECK_POSITIVE_TORQUE_HOME_TO_POS,
