...
typedef enum {
    ...
    MAVLINK_GIMBAL_PARAM_GMB_AZ_TRQ_P,
    MAVLINK_GIMBAL_PARAM_GMB_AZ_TRQ_I,
    MAVLINK_GIMBAL_PARAM_GMB_AZ_TRQ_D,
    MAVLINK_GIMBAL_PARAM_GMB_EL_TRQ_P,
    MAVLINK_GIMBAL_PARAM_GMB_EL_TRQ_I,
    MAVLINK_GIMBAL_PARAM_GMB_EL_TRQ_D,
    MAVLINK_GIMBAL_PARAM_GMB_RL_TRQ_P,
    MAVLINK_GIMBAL_PARAM_GMB_RL_TRQ_I,
    MAVLINK_GIMBAL_PARAM_GMB_RL_TRQ_D,
