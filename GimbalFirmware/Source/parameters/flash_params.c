...
struct flash_param_struct_0001 flash_params =
{
		...
		0.0,        	        	// Software version number, loaded from compiled in version information at boot time
		0.0,    	    	        // Unix timestamp (seconds since Jan 01 1970 UTC)
		0.0, 	            	    // Serial number part 1 (part code, design, language/country)
		0.0, 	    	            // Serial number part 2 (option, year, month)
		0.0,    	    	        // Serial number part 3 (incrementing serial number per month)
