...
/*
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_POS_PID_YAW_P].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_POS_PID_YAW_I].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_POS_PID_YAW_D].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_POS_PID_YAW_I_MAX].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_POS_PID_PITCH_P].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_POS_PID_PITCH_I].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_POS_PID_PITCH_D].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_POS_PID_PITCH_I_MAX].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_POS_PID_ROLL_P].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_POS_PID_ROLL_I].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_POS_PID_ROLL_D].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_POS_PID_ROLL_I_MAX].access_type = GIMBAL_PARAM_READ_WRITE;
*/
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_GYRO_OFFSET_YAW].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_GYRO_OFFSET_PITCH].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_GYRO_OFFSET_ROLL].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_COMMUTATION_CALIBRATION_YAW_HOME_OFFSET].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_COMMUTATION_CALIBRATION_PITCH_HOME_OFFSET].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_COMMUTATION_CALIBRATION_ROLL_HOME_OFFSET].access_type = GIMBAL_PARAM_READ_WRITE;
    ...
    strncpy(gimbal_params[MAVLINK_GIMBAL_PARAM_SYSID_ASSEMBLY_DATE].param_id, "SYSID_ASSY_DATE", MAVLINK_MSG_PARAM_VALUE_FIELD_PARAM_ID_LEN + 1);
    ...
    strncpy(gimbal_params[MAVLINK_GIMBAL_PARAM_SYSID_ASSEMBLY_TIME].param_id, "SYSID_ASSY_TIME", MAVLINK_MSG_PARAM_VALUE_FIELD_PARAM_ID_LEN + 1);
    gimbal_params[MAVLINK_GIMBAL_PARAM_SYSID_ASSEMBLY_TIME].can_parameter_id = CAND_PID_INVALID;
    gimbal_params[MAVLINK_GIMBAL_PARAM_SYSID_ASSEMBLY_TIME].param_type = MAV_PARAM_TYPE_UINT32;
    ...
    gimbal_params[MAVLINK_GIMBAL_PARAM_SERIAL_BAUD].access_type = GIMBAL_PARAM_READ_WRITE;
