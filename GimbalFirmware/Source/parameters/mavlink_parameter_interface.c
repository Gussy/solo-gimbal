...
void init_default_mavlink_params()
{
    ...
    strncpy(gimbal_params[MAVLINK_GIMBAL_PARAM_GYRO_OFFSET_YAW].param_id, "GMB_OFF_YAW", MAVLINK_MSG_PARAM_VALUE_FIELD_PARAM_ID_LEN + 1);
    ...
    strncpy(gimbal_params[MAVLINK_GIMBAL_PARAM_GYRO_OFFSET_PITCH].param_id, "GMB_OFF_PITCH", MAVLINK_MSG_PARAM_VALUE_FIELD_PARAM_ID_LEN + 1);
    ...
    strncpy(gimbal_params[MAVLINK_GIMBAL_PARAM_GYRO_OFFSET_ROLL].param_id, "GMB_OFF_ROLL", MAVLINK_MSG_PARAM_VALUE_FIELD_PARAM_ID_LEN + 1);
    ...
    strncpy(gimbal_params[MAVLINK_GIMBAL_PARAM_COMMUTATION_CALIBRATION_YAW_HOME_OFFSET].param_id, "GMB_YAW_HOME", MAVLINK_MSG_PARAM_VALUE_FIELD_PARAM_ID_LEN + 1);
    ...
    strncpy(gimbal_params[MAVLINK_GIMBAL_PARAM_COMMUTATION_CALIBRATION_PITCH_HOME_OFFSET].param_id, "GMB_PITCH_HOME", MAVLINK_MSG_PARAM_VALUE_FIELD_PARAM_ID_LEN + 1);
    ...
    strncpy(gimbal_params[MAVLINK_GIMBAL_PARAM_COMMUTATION_CALIBRATION_ROLL_HOME_OFFSET].param_id, "GMB_ROLL_HOME", MAVLINK_MSG_PARAM_VALUE_FIELD_PARAM_ID_LEN + 1);
    ...
    strncpy(gimbal_params[MAVLINK_GIMBAL_PARAM_SYSID_ASSEMBLY_TIME].param_id, "GMB_ASSY_TIME", MAVLINK_MSG_PARAM_VALUE_FIELD_PARAM_ID_LEN + 1);
