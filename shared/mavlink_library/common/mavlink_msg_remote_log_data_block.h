...
#elif MAVLINK_C2000
		mav_put_uint32_t_c2000(&(msg->payload64[0]), 0, block_cnt);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 4, target_system);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 5, target_component);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 6, block_size);
	
		mav_put_uint8_t_array_c2000(&(msg->payload64[0]), data, 7, 200);
...
#else
	return mav_get_uint8_t_array_c2000(&(msg->payload64[0]), data, 200,  7);
#endif
}
