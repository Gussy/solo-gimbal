...
#elif MAVLINK_C2000
		mav_put_float_c2000(&(msg->payload64[0]), 0, angle_x);
		mav_put_float_c2000(&(msg->payload64[0]), 4, angle_y);
		mav_put_float_c2000(&(msg->payload64[0]), 8, distance);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 12, target_num);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 13, frame);
