...
#elif MAVLINK_C2000
		mav_put_int16_t_c2000(&(msg->payload64[0]), 0, rl_torque_cmd);
		mav_put_int16_t_c2000(&(msg->payload64[0]), 2, el_torque_cmd);
		mav_put_int16_t_c2000(&(msg->payload64[0]), 4, az_torque_cmd);
