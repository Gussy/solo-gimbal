...
#elif MAVLINK_C2000
		mav_put_float_c2000(&(msg->payload64[0]), 0, desired);
		mav_put_float_c2000(&(msg->payload64[0]), 4, achieved);
		mav_put_float_c2000(&(msg->payload64[0]), 8, FF);
		mav_put_float_c2000(&(msg->payload64[0]), 12, P);
		mav_put_float_c2000(&(msg->payload64[0]), 16, I);
		mav_put_float_c2000(&(msg->payload64[0]), 20, D);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 24, axis);
