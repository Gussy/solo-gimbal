...
#elif MAVLINK_C2000
		mav_put_float_c2000(&(msg->payload64[0]), 0, h_acc);
		mav_put_float_c2000(&(msg->payload64[0]), 4, s_acc);
		mav_put_float_c2000(&(msg->payload64[0]), 8, h_vel_filt);
		mav_put_float_c2000(&(msg->payload64[0]), 12, v_vel_filt);
		mav_put_float_c2000(&(msg->payload64[0]), 16, p_drift);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 20, instance);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 21, ekf_check_mask);
