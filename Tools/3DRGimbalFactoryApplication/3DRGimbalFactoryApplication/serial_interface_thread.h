...
enum TestResult {
    TEST_RESULT_ENCODER_RANGE_AZ = 0,
    TEST_RESULT_ENCODER_ASYMMETRY_AZ,
    TEST_RESULT_NEG_MAX_TORQUE_AZ,
    TEST_RESULT_POS_MAX_TORQUE_AZ,
    TEST_RESULT_ENCODER_RANGE_EL,
    TEST_RESULT_ENCODER_ASYMMETRY_EL,
    TEST_RESULT_NEG_MAX_TORQUE_EL,
    TEST_RESULT_POS_MAX_TORQUE_EL,
    TEST_RESULT_ENCODER_RANGE_RL,
    TEST_RESULT_ENCODER_ASYMMETRY_RL,
    TEST_RESULT_NEG_MAX_TORQUE_RL,
    TEST_RESULT_POS_MAX_TORQUE_RL,
    TEST_RESULT_NEG_MAX_TORQUE_LOC_AZ,
    TEST_RESULT_NEG_MAX_TORQUE_LOC_EL,
    TEST_RESULT_NEG_MAX_TORQUE_LOC_RL,
    TEST_RESULT_POS_MAX_TORQUE_LOC_AZ,
    TEST_RESULT_POS_MAX_TORQUE_LOC_EL,
    TEST_RESULT_POS_MAX_TORQUE_LOC_RL,
    TEST_RESULT_NEG_AVG_TORQUE_AZ,
    TEST_RESULT_NEG_AVG_TORQUE_EL,
    TEST_RESULT_NEG_AVG_TORQUE_RL,
    TEST_RESULT_POS_AVG_TORQUE_AZ,
    TEST_RESULT_POS_AVG_TORQUE_EL,
    TEST_RESULT_POS_AVG_TORQUE_RL
};
