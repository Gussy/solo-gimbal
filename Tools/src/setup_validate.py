...
EXPECTED_ACC_ALIGN_X_MIN = 0.0
EXPECTED_ACC_ALIGN_X_MAX = 0.1
EXPECTED_ACC_ALIGN_Y_MIN = 0.0
EXPECTED_ACC_ALIGN_Y_MAX = 0.02
EXPECTED_ACC_ALIGN_Z_MIN = 0.0
EXPECTED_ACC_ALIGN_Z_MAX = 0.0

EXPECTED_ACC_OFFSET_X_MIN = -1.0
EXPECTED_ACC_OFFSET_X_MAX = 1.0
EXPECTED_ACC_OFFSET_Y_MIN = -0.5
EXPECTED_ACC_OFFSET_Y_MAX = 0.5
EXPECTED_ACC_OFFSET_Z_MIN = -0.25
EXPECTED_ACC_OFFSET_Z_MAX = 0.25
