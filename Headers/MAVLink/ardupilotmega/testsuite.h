...
static void mavlink_test_gimbal_init(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_gimbal_init_t packet_in = {
		5,72
    };
	mavlink_gimbal_init_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.target_system = packet_in.target_system;
        	packet1.target_component = packet_in.target_component;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_init_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_gimbal_init_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_init_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component );
	mavlink_msg_gimbal_init_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_init_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component );
	mavlink_msg_gimbal_init_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_gimbal_init_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_init_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component );
	mavlink_msg_gimbal_init_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_gimbal_home(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_gimbal_home_t packet_in = {
		5,72
    };
	mavlink_gimbal_home_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.target_system = packet_in.target_system;
        	packet1.target_component = packet_in.target_component;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_home_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_gimbal_home_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_home_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component );
	mavlink_msg_gimbal_home_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_home_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component );
	mavlink_msg_gimbal_home_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_gimbal_home_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_home_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component );
	mavlink_msg_gimbal_home_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_actuate_camera_shutter(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_actuate_camera_shutter_t packet_in = {
		5,72
    };
	mavlink_actuate_camera_shutter_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.target_system = packet_in.target_system;
        	packet1.target_component = packet_in.target_component;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_actuate_camera_shutter_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_actuate_camera_shutter_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_actuate_camera_shutter_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component );
	mavlink_msg_actuate_camera_shutter_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_actuate_camera_shutter_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component );
	mavlink_msg_actuate_camera_shutter_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_actuate_camera_shutter_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_actuate_camera_shutter_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component );
	mavlink_msg_actuate_camera_shutter_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_query_gimbal_camera_presence(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_query_gimbal_camera_presence_t packet_in = {
		5,72
    };
	mavlink_query_gimbal_camera_presence_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.target_system = packet_in.target_system;
        	packet1.target_component = packet_in.target_component;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_query_gimbal_camera_presence_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_query_gimbal_camera_presence_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_query_gimbal_camera_presence_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component );
	mavlink_msg_query_gimbal_camera_presence_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_query_gimbal_camera_presence_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component );
	mavlink_msg_query_gimbal_camera_presence_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_query_gimbal_camera_presence_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_query_gimbal_camera_presence_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component );
	mavlink_msg_query_gimbal_camera_presence_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_gimbal_camera_presence(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_gimbal_camera_presence_t packet_in = {
		5,72,139
    };
	mavlink_gimbal_camera_presence_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.target_system = packet_in.target_system;
        	packet1.target_component = packet_in.target_component;
        	packet1.camera_presence = packet_in.camera_presence;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_camera_presence_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_gimbal_camera_presence_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_camera_presence_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.camera_presence );
	mavlink_msg_gimbal_camera_presence_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_camera_presence_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.camera_presence );
	mavlink_msg_gimbal_camera_presence_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_gimbal_camera_presence_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_camera_presence_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.camera_presence );
	mavlink_msg_gimbal_camera_presence_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_gimbal_fault(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_gimbal_fault_t packet_in = {
		5,72
    };
	mavlink_gimbal_fault_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.fault_axis = packet_in.fault_axis;
        	packet1.fault_type = packet_in.fault_type;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_fault_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_gimbal_fault_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_fault_pack(system_id, component_id, &msg , packet1.fault_axis , packet1.fault_type );
	mavlink_msg_gimbal_fault_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_fault_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.fault_axis , packet1.fault_type );
	mavlink_msg_gimbal_fault_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_gimbal_fault_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gimbal_fault_send(MAVLINK_COMM_1 , packet1.fault_axis , packet1.fault_type );
	mavlink_msg_gimbal_fault_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_set_gimbal_beacon(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_set_gimbal_beacon_t packet_in = {
		5,72,139,206
    };
	mavlink_set_gimbal_beacon_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.target_system = packet_in.target_system;
        	packet1.target_component = packet_in.target_component;
        	packet1.beacon_mode = packet_in.beacon_mode;
        	packet1.beacon_brightness = packet_in.beacon_brightness;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_gimbal_beacon_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_set_gimbal_beacon_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_gimbal_beacon_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.beacon_mode , packet1.beacon_brightness );
	mavlink_msg_set_gimbal_beacon_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_gimbal_beacon_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.beacon_mode , packet1.beacon_brightness );
	mavlink_msg_set_gimbal_beacon_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_set_gimbal_beacon_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_gimbal_beacon_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.beacon_mode , packet1.beacon_brightness );
	mavlink_msg_set_gimbal_beacon_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_gopro_response(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_gopro_response_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gopro_response_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.gp_cmd_name_1 , packet1.gp_cmd_name_2 , packet1.gp_cmd_response_status , packet1.gp_cmd_result );
	mavlink_msg_gopro_response_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gopro_response_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.gp_cmd_name_1 , packet1.gp_cmd_name_2 , packet1.gp_cmd_response_status , packet1.gp_cmd_result );
	mavlink_msg_gopro_response_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_gopro_response_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gopro_response_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.gp_cmd_name_1 , packet1.gp_cmd_name_2 , packet1.gp_cmd_response_status , packet1.gp_cmd_result );
	mavlink_msg_gopro_response_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_gimbal_init(system_id, component_id, last_msg);
	mavlink_test_gimbal_home(system_id, component_id, last_msg);
	mavlink_test_actuate_camera_shutter(system_id, component_id, last_msg);
	mavlink_test_query_gimbal_camera_presence(system_id, component_id, last_msg);
	mavlink_test_gimbal_camera_presence(system_id, component_id, last_msg);
	mavlink_test_gimbal_fault(system_id, component_id, last_msg);
	mavlink_test_set_gimbal_beacon(system_id, component_id, last_msg);
